...
DEBUG = False
JSON_FILE = os.path.join(here, 'p02.json')
IMAGE_FILE = os.path.join(here, 'p02.jpg')
FILE_PATH_DEBUG = '../../input/p02/p02.csv'
...
VAR_LIST = {
        ...
        'temperature': {'netcdf_var': 'temperature', 'match': ['Temp', '°C'], 'pandas_col': None},
    }
